...
@interface FXDropTransitionAnimator ()<UIDynamicAnimatorDelegate, UICollisionBehaviorDelegate>
...
@implementation FXDropTransitionAnimator
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    if (self.appearing) {
        ...
        __weak FXDropTransitionAnimator *weakSelf = self;
        self.action = ^{
            __strong FXDropTransitionAnimator *strongSelf = weakSelf;
            if (strongSelf) {
